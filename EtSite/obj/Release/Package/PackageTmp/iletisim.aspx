        ...
        <asp:TextBox ID="txtTel" runat="server"></asp:TextBox>
         ...
         <tr>
            <td class="auto-style8">Mesajınız</td>
             <td class="auto-style6">:<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtMesaj" ErrorMessage="*" ForeColor="Red" ValidationGroup="grbiletisim"></asp:RequiredFieldValidator>
                            </td>
             <td>
                 <label for="mail" style="font-size: large; font-weight: bold; color: #FF0000">
                 <asp:TextBox ID="txtMesaj" runat="server" TextMode="MultiLine" Height="108px" Width="500px"></asp:TextBox>
                 </label>
             </td>
         </tr>
         <tr>
