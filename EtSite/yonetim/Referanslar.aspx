<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/AnaPage.Master" AutoEventWireup="true" CodeBehind="Referanslar.aspx.cs" Inherits="EtSite.yonetim.Referanslar" %>
            ...
            <td class="auto-style2">
                <div class="well">
                    ...
                    <table class="auto-style1">
                        ...
                        <tr>
                            <td class="auto-style5">Ref Adı</td>
                        ...
                        <tr>
                            <td class="auto-style5">Site Url</td>
                            <td class="auto-style4">:</td>
                            <td>
                    ...
                    <asp:Repeater ID="RpKayit" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <img src="/Resimler/Ref/<%#Eval("Resim")%> " width="35" height="30" title="<%#Eval("RefAdi")%>" /></td>
                                <td><%#Eval("Durumadi")%></td>

                                <td>


                                    <a href="Referanslar.aspx?RefId=<%#Eval("RefId")%>&islem=duzenle" title="Düzenle"><i class="icon-pencil"></i></a>

                                    <a onclick="return confirm('Dikkat: (<%#Eval("RefId") %>) Numaralı Referansı Silmek İstediğinizden Emin Misiniz?');" href="Referanslar.aspx?RefId=<%#Eval("RefId")%>&islem=sil" title="Sil"><i class="icon-remove"></i></a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
