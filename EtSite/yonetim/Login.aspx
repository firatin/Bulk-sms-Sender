<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EtSite.Yonet.Login" %>
    ...
    <div class="dialog">
        <div class="block">
            ...
            <div class="block-body">
                <form>
                Kullanıcı Adı: <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtKullaniciAdi" ForeColor="Red"></asp:RequiredFieldValidator>
                    <asp:TextBox ID="txtKullaniciAdi" runat="server" CssClass="span12"></asp:TextBox>
